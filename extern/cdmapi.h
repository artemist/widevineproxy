...
// This code was taken from Firefox, which took this code from Chromium. It has been slightly modified.
...
class EXPORT AudioFrames;
class EXPORT DecryptedBlock;
class EXPORT VideoFrame;
...
class EXPORT ContentDecryptionModule_8 {
 public:
...
// be passed back to the caller. Implementations must call Buffer::Destroy()
// when a Buffer is created that will never be returned to the caller.
class EXPORT ContentDecryptionModule_9 {
 public:
